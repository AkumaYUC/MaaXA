...
public static class ConfigurationKeys
{
    ...
    public const string OrderArchiveDirectory = "OrderArchiveDirectory";
    public const string OrderArchiveRetention = "OrderArchiveRetention";
    public const string OrderArchiveCustomDays = "OrderArchiveCustomDays";
